    ...
    public partial class frmDetalleCompra : Form
    {
        ...
        private void btnBuscarproveedor_Click(object sender, EventArgs e)
        {
            ...
            if (oCompra.IdCompra != 0)
            {
                ...
                txtfecha.Text = oCompra.TipoDocumento;
                txttipodocumento.Text = oCompra.oUsuario.NombreCompleto;
                ...
                {
                    dgvdata.Rows.Add(new object[] { dc.oProducto.Nombre, dc.Cantidad, dc.MontoTotal });
                }
        ...
        private void btndescargarpdf_Click(object sender, EventArgs e, Document pdfDoc)
        {
        ...
        private void btndescargarpdf_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No se encontrarón resultados", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
